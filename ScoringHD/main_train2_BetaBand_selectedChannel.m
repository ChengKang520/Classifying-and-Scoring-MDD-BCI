...
for k = 1:Kfold
    ...
    for task = 1:tasks
        ...
        if task == 1
            ...
            EEGDataH = permute(EEGDataH.EEGdata_back0, [2 3 1]);
            EEGDataH = filter(mybandpassfilterIIR_EEG_500(Fs, 14, 40, 4),EEGDataH);
            EEGDataH = permute(EEGDataH, [3 1 2]);
            ...
            EEGDataD = permute(EEGDataD.EEGdata_back0, [2 3 1]);
            EEGDataD = filter(mybandpassfilterIIR_EEG_500(Fs, 14, 40, 4),EEGDataD);
            EEGDataD = permute(EEGDataD, [3 1 2]);
            ...
            EEGDataH_label = ones(1, size_EEGDataH(1)) * 10;
                ...
                EEGDataH = permute(EEGDataH.EEGdata_back1, [2 3 1]);
                EEGDataH = filter(mybandpassfilterIIR_EEG_500(Fs, 14, 40, 4),EEGDataH);
                EEGDataH = permute(EEGDataH, [3 1 2]);
                ...
                EEGDataD = permute(EEGDataD.EEGdata_back1, [2 3 1]);
                EEGDataD = filter(mybandpassfilterIIR_EEG_500(Fs, 14, 40, 4),EEGDataD);
                EEGDataD = permute(EEGDataD, [3 1 2]);
                ...
                EEGDataH_label = ones(1, size_EEGDataH(1)) * 10;
                    ...
                    EEGDataH = permute(EEGDataH.EEGdata_back2, [2 3 1]);
                    EEGDataH = filter(mybandpassfilterIIR_EEG_500(Fs, 14, 40, 4),EEGDataH);
                    EEGDataH = permute(EEGDataH, [3 1 2]);
                    ...
                    EEGDataD = permute(EEGDataD.EEGdata_back2, [2 3 1]);
                    EEGDataD = filter(mybandpassfilterIIR_EEG_500(Fs, 14, 40, 4),EEGDataD);
                    EEGDataD = permute(EEGDataD, [3 1 2]);
        ...
        %% Save Data
        save_testFeature_name = strcat('Beta_testFeature_Nback', num2str(task-1),'Fold',num2str(k));
        save([workspace_addr, save_testFeature_name], 'test');
        save_netTransfer_name = strcat('Beta_netTransfer_Nback', num2str(task-1),'Fold',num2str(k));
        ...
        save_figure_name = strcat('Beta_Figure_Nback', num2str(task-1),'Fold',num2str(k));
